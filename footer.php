            ...
            <div class="af-container-row">
                <div class="col-1 color-pad">
                    ...
                    <?php if ($morenews_theme_credits != 1): ?>
                        <span class="sep"> | </span>
                        <a href="https://afthemes.com/products/morenews/" title="Шаблон WordPress" rel="designer">Тема MoreNews от AF themes. Создано на WordPress.</a>
						<span class="sep"> | </span>
						<a href="http://vandraren.ru/" title="Создание и техническая поддержка сайта: VANDRAREN - Разработка web-проектов" target="_blank">
                        Создание и техническая поддержка сайта: vandraren.ru    
                        </a>
                    <?php endif; ?>
                </div>
            </div>
